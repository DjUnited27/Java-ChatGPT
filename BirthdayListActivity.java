...
public class BirthdayListActivity extends AppCompatActivity {
    ...
    public class Person {
        ...
        public void savePersonToFile(Context context, String name, String surname, String company, String birthday) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(BIRTHDAY_LIST_FILE, true))) {
        ...
        private ArrayList<PersonInfo> readFiles(Context context) {
            ...
            try (InputStream is = context.getAssets().open("birthdays.txt");
                ...
                while (line != null) {
                    ...
                    String birthday = birthdateParts[0].trim();
                    String birthMonth = birthdateParts[1].trim();
                    String birthYear = birthdateParts[2].trim();
                    String company = parts[2].trim();
                    list.add(new Person(name, null, birthday, birthMonth, birthYear, company));
